...
class Apm extends StatefulWidget {
  final int waktuTes;
  Apm(this.waktuTes);
  @override
  _ApmState createState() => _ApmState();
}

class _ApmState extends State<Apm> {
  ...
  ceklocalJawab() {
    if (_listPilihan[_index - 1] == "1") {
      _indexAnswer = 1;
    }
    if (_listPilihan[_index - 1] == "2") {
      _indexAnswer = 2;
    }
    if (_listPilihan[_index - 1] == "3") {
      _indexAnswer = 3;
    }
    if (_listPilihan[_index - 1] == "4") {
      _indexAnswer = 4;
    }
    if (_listPilihan[_index - 1] == "5") {
      _indexAnswer = 5;
    }
    if (_listPilihan[_index - 1] == "6") {
      _indexAnswer = 6;
    }
    if (_listPilihan[_index - 1] == "7") {
      _indexAnswer = 7;
    }
    if (_listPilihan[_index - 1] == "8") {
      _indexAnswer = 8;
    }
  ...
  getLocalData() async {
    ...
    showDialog(
        context: context,
        builder: (context) => CustomDialog("Instruksi", intruksi));
  }
  ...
  getSoal(String url) async {
    ...
    try {
      ...
      if (_index == 0) {
        ...
        _listPilihanBenar = List<String>.generate(totalPage, (i) => "");
        print(_listPilihan);
        print(_listPilihanBenar);
      }
      ...
      _listPilihanBenar[_index - 1] = response['data'][0]['jawaban_soal'];
      print(sUrlPrev);
                              ...
                              children: <Widget>[
                                ...
                                MaterialButton(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(15),
                                      color: _indexAnswer == 6
                                          ? Colors.grey
                                          : Colors.white,
                                      image: DecorationImage(
                                          image: pilihan[5] != ""
                                              ? NetworkImage(pilihan[5])
                                              : NetworkImage(""),
                                          fit: BoxFit.contain),
                                      boxShadow: [
                                        BoxShadow(
                                ...
                                MaterialButton(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(15),
                                      color: _indexAnswer == 7
                                          ? Colors.grey
                                          : Colors.white,
                                      image: DecorationImage(
                                          image: pilihan[6] != ""
                                              ? NetworkImage(pilihan[6])
                                              : NetworkImage(""),
                                          fit: BoxFit.contain),
                                      boxShadow: [
                                        BoxShadow(
                                ...
                                MaterialButton(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(15),
                                      color: _indexAnswer == 8
                                          ? Colors.grey
                                          : Colors.white,
                                      image: DecorationImage(
                                          image: pilihan[7] != ""
                                              ? NetworkImage(pilihan[7])
                                              : NetworkImage(""),
                                          fit: BoxFit.contain),
                                      boxShadow: [
                                        BoxShadow(
  ...
  _showFalseDialog(BuildContext context) {
    // set up the buttons
    Widget continueButton = TextButton(
      child: Text("Iya"),
      onPressed: () {
    ...
    AlertDialog alert = AlertDialog(
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15)),
      title: Text("Perhatian"),
      content: Text("Jawaban Anda masih ada yang salah, mohon teliti lagi!"),
      actions: [
        continueButton,
      ],
    );

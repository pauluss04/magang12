...
class CfitTigaA extends StatefulWidget {
  final int waktuTes;
  CfitTigaA(this.waktuTes);
  @override
  _CfitTigaAState createState() => _CfitTigaAState();
}

class _CfitTigaAState extends State<CfitTigaA> {
